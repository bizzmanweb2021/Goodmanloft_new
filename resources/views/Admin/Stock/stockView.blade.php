    ...
    <div class="card mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-right">
                ...
                <a class="btn btn-soft-info  btn-icon btn-circle btn-sm" href="{{route('admin.file-export1')}}"><i class="fa fa-file-excel-o fa_custom fa-4x" style="font-size:35px;color:green"></i>
</div>
</div>
