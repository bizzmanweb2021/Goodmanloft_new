      ...
      @endif
          {{method_field('POST')}}
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <label class="text-truncate  text-body ms-3 w-80 mb-0">Color</label>
                    <input type="text" name="Color" class="form-control" style="width:100%">
                </div></br>
            </div>
            <div class="row mb-4">
                <div class="col-md-4">
                    <label class="text-truncate  text-body ms-3 w-80 mb-0">Pattern</label>
                    <input type="text" name="Pattern" class="form-control" style="width:100%">
                </div><br>
                <div class="col-md-4">
                    <label class="text-truncate  text-body ms-3 w-80 mb-0">Shape</label>
                    <input type="text" name="Shape" class="form-control" style="width:100%">
                </div><br>
                <div class="col-md-4">
                    <label class="text-truncate  text-body ms-3 w-80 mb-0">Weight</label>
                    <input type="text" name="Weight" class="form-control" placeholder="in Kg" style="width:100%">
                </div><br>
            </div>
            <div class="row mb-4">
                <div class="col-md-4">
                    <label class="text-truncate  text-body ms-3 w-80 mb-0">Brand</label>
