...
@section('title')
<h6 class="font-weight-bolder mb-0">Edit AboutUs</h6>
@endsection
@section('content')
  ...
  <div class="col-12">
    <div class="card h-100">
      ...
      <div class="card-body p-3">
        <form method="POST" action="{{ route('admin.update.about',$about[0]->id) }}">
            @csrf
            <div class="row ">
                    <div class="col-md-6">
                        <label class="text-truncate  text-body ms-3 w-80 ">Title</label>
                        <input type="text" name="Title" class="form-control" value="{{ $about[0]->Title }}">
                    </div><br>
            </div><br>
            <div class="row mb-4">
                <div class="col-md-12">
                    <label class="text-truncate  text-body ms-3 w-80 ">Description</label>
                    <textarea type="text" name="Description" style="heigth:100px; width:100%;" class="form-control">{{ $about[0]->Description }}</textarea>
                </div><br>
        </div><br>
            <div class="col-md-4">
